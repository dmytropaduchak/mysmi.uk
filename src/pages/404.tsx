...
export default function NotFound() {
  ...
  return (
    <>
      <Head>
        <title>Page Not Found | mySMI.uk</title>
        <meta name="description" content="The page you're looking for does not exist. Explore mySMI.uk to discover a variety of self-tests and insights." />
        <meta name="keywords" content="404 error, missing page, mySMI.uk" />
      </Head>
      <Header/>
      <Box sx={{
        display: "flex",
