...
export default function CookieStatement() {
  ...
  return (
    <>
      <Head>
        <title>Cookie Statement | mySMI.uk</title>
        <meta
          name="description"
          content="Learn how mySMI.uk uses cookies and similar technologies to keep the website working, remember preferences, and understand performance."
        />
        <meta
          name="keywords"
          content="mySMI.uk cookies, cookie statement, cookie policy, mobile car locksmith, website analytics, preferences"
        />
      </Head>
      <Box sx={{
        backgroundImage,
        ...
        <Box sx={{
          ...
          <Box sx={{ maxWidth: 900 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 3, textAlign: { xs: "center", md: "left" } }}>
              How mySMI.uk uses cookies and similar technologies.
            </Typography>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
              At <Box component="span" sx={{ color: "primary.main" }}> mySMI.uk </Box>, we use cookies (and similar technologies such as local storage) to keep the website working, remember
            ...
            <Box component="ul" sx={{ m: 0, pl: 2.5, color: "text.secondary" }}>
              ...
              <Box component="li">
                <Typography variant="body1" color="text.secondary">
                  ...
                  We do not run third-party advertising on mySMI.uk. If we ever add marketing cookies in the future,
