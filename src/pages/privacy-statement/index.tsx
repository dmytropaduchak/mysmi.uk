...
export default function PrivacyStatement() {
  ...
  return (
    <>
      <Head>
        <title>Privacy Statement | mySMI.uk</title>
        <meta
          name="description"
          content="Learn how mySMI.uk collects, uses, and protects your personal data when you use our website and contact us for mobile auto locksmith services."
        />
        <meta
          name="keywords"
          content="mySMI.uk privacy, privacy statement, UK GDPR, data protection, mobile car locksmith"
        />
      </Head>
      <Box
        sx={{
        ...
        >
          <Box sx={{ maxWidth: 900 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 3, textAlign: { xs: "center", md: "left" } }}>
              ...
              mySMI.uk and contact us for mobile auto locksmith services.
            </Typography>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
              ...
              provides mobile auto locksmith services. We aim to comply with applicable UK data protection laws,
            ...
            <Box component="ul" sx={{ m: 0, pl: 2.5, color: "text.secondary" }}>
              ...
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
                  ...
                  vehicle make/model/year, key type, issue description, and your location/postcode (to attend).
                </Typography>
              </Box>
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
                  ...
                  messages and information you send via phone, WhatsApp, email, or contact forms.
                </Typography>
              </Box>
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
            ...
            <Box component="ul" sx={{ m: 0, pl: 2.5, color: "text.secondary" }}>
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
                  Provide quotes, arrange attendance, and deliver the service you requested.
                </Typography>
              </Box>
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
                  Respond to enquiries and communicate about your booking or job.
                </Typography>
              </Box>
              <Box component="li" sx={{ mb: 1 }}>
                <Typography variant="body1" color="text.secondary">
                  Improve our website, reliability, and customer experience.
                </Typography>
              </Box>
              <Box component="li">
                <Typography variant="body1" color="text.secondary">
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 1.5 }}>
              ...
              our website and communications (for example, hosting, analytics, email, and messaging platforms such as
              WhatsApp), or where required by law.
            </Typography>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
              We keep personal data only as long as necessary for the purposes described above, including handling
              enquiries, providing services, and meeting legal or accounting obligations.
            </Typography>
