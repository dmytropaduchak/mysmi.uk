...
export default function InternalServerError() {
  ...
  return (
    <>
      <Head>
        <title>Server Error | mySMI.uk</title>
        <meta name="description" content="Something went wrong. Please try again later while we restore mySMI.uk online test services." />
        <meta name="keywords" content="500 error, server error, technical issue, mySMI.uk" />
      </Head>
      <Header/>
      <Box sx={{
        display: "flex",
