        ...
        >
          <CardContent sx={{
            ...
            <Typography noWrap={false} variant="body2" sx={{
              ...
              mySMI.uk uses a few tracking technologies to keep insights accurate and your experience secure. You can choose what to share.
            </Typography>
            <Button
              variant="outlined"
              color="secondary"
        ...
        >
          ...
          <DialogContent>
            <Typography variant="body1" color="secondary" sx={{
              paddingBottom: 2,
              fontWeight: 200,
            }}>mySMI.uk uses a few tracking technologies to keep insights accurate and your experience secure. You can choose what to share.</Typography>
            {settings.map((i, key) => (
